...
=======
# btc-2009-prng-recovery-bruteforce
Проект реконструирует состояние системы типичного криптоэнтузиаста 2009 года во время первого запуска bitcoin 0.1.0, позволяя подобрать удачную комбинацию системной энтропии PRNG для предварительно сформированного списка кошельков 2009-2011 года, позволяя получить доступ к забытым кошелькам с балансом от 25 до 1000+ BTC!
>>>>>>> 32f21c5 (Initial commit)
